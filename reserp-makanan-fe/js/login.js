...
document.getElementById("signInButton").addEventListener("click", function (event) {
  ...
  // Prepare the data object based on the input type
  const data = isEmail ? { email: emailOrUsername, password: password } : { username: emailOrUsername, password: password };
  ...
  .then((data) => {
    if (data.token) {
      // Use the correct object structure from the response
